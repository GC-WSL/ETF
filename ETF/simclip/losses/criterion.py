...
def sigmoid_focal_loss(inputs, targets, num_masks, alpha: float = 0.50, gamma: float = 2):
    """
...
class SetCriterion(nn.Module):
    ...
    def loss_labels(self, outputs, targets, indices, num_masks,weights = None):
    ...
    def loss_masks(self, outputs, targets, indices, num_masks,weights = None):
