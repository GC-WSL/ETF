...
def clip_big_image(image_path, clip_save_dir, to_label=False):
    ...
    xmin = x * ss #NOTE: The original setting was clip_size here, but which is logical error. It ignores the stride_size and thus crop:512, stride:512 is generated.
    ymin = y * ss #NOTE: The original setting was clip_size here, but which is logical error. It ignores the stride_size and thus crop:512, stride:512 is generated.
...
def main():
    ...
    with tempfile.TemporaryDirectory(dir=args.tmp_dir) as tmp_dir:
        for zipp in zipp_list:
            ...
            prog_bar = mmengine.utils.progressbar.ProgressBar(len(src_path_list))
